...
var dialogs = {
	"Rose": [
		[ 1, 0.5, "Hey there, cutie! My name is Rose... What are you doing around here? ", 
		...
		[ 2, 0.5, "It’s been quite chilly lately, hasn’t? I’m feeling a bit cold... Oh, if only there was something I could do about it...  ", 
		...
		[ 3, 0.5, "I’ve met all these different roses in my past, but none of them really appreciated me! I’ve tried getting to know some of them, but it never led anywhere... I need someone to REALLY seal the deal.  ", 
		...
		[ 4, 1, "Hello there, darling. You look like you’re worked up over something. Surely I’m not making you nervous, am I?   ", 
		...
		[ 5, 1, "My darling, I’m feeling a bit down, all this growing is really tiring. I need someone to cheer me up...", 
		...
		[ 6, 1, "My love, I cannot wait any longer, I want you to hold me. I want your sweet nectar. Please, let’s make some sweet memories together.", 
		...
		[ 4, 0, "Oh, it’s you... Why aren’t you with the other flowers? I’m sure you would rather spend time with them than with an ugly rose like me...", 
		...
		[ 5, 0, "It’s you again... You don’t like me, so why do you keep talking to me? Honestly, it would just be better if you left me without any water.", 
		...
		[ 6, 0, "Why are you here... We both know there’s nothing happening between us, and everyday you just come back here to rub it in my face! I should have just stuck to those stupid roses...", 
	...
	"Bella & Donna": [
		...
		[ 2, 0.5, "Bella: Have you heard the tale of the girl in the nearby forest?\nDonna: they say she went to pick berries for a delicious pie...\nBella: but she never returned from her trip. What do you think happened to her, farmer?", 
			[ "Maybe she found a wolf, who scarfed her down?", NEUT, "Donna: oooh, I like that idea!\nBella: well it’s not how the story goes...\nDonna: I don’t mind that, a story can be changed, after all.\nBella: but not this story!" ], 
			[ "She might have picked the wrong kind of berry.", GOOD, "Bella: that’s right! You're a smart one, aren’t you?\nDonna: we like smart people like you, farmer. Maybe you could tell us a story next time?" ], 
			[ "I don’t really care much for fairy tales.", BAD, "Bella: You’re no fun!\nDonna: I don’t think he would like this particular story, anyways\nBella: yeah, you’re right." ]
		],
		[ 3, 0.5, "Bella: it can get a bit lonely out here, we’re not exactly popular with the other flowers... \nDonna: You might even say we’re scaring them away \nBella: but that’s not our fault! This is just the way we are...", 
			[ "I would be gladly keep you company instead", GOOD, "Donna: and we would gladly have you! \nBella: Donna, control yourself a little... \nDonna: sorry, I just got exited over making a new friend..." ], 
			[ "You have each other, don’t you?", NEUT, "Bella: I suppose that is true, Yes... \nDonna: but there isn’t much to talk about between twins, you see? \nBella: But it is true that we have each other’s backs. \nDonna: literally!" ], 
			[ "I think I understand why you’re freaking them out.", BAD, "Bella: do we freak you out too? \nDonna: well that’s too bad, isn’t it? We can get much, much creepier if we want to... \nBella: maybe we should show you, so you will appreciate us for how we are normally..." ]
		],
		[ 4, 1, "Donna: it’s a shame we don’t have our berries anymore... \nBella: you should have seen them, farmer! I’m sure they would have charmed you. They were both very big, and... voluptuous.", 
			[ "I bet they were very juicy. I’d love to see them once they grow back.", GOOD, "Donna: Oh my! You're such a flatterer, you know that, farmer? \nBella: It might take a while, but we would be happy to show you once they’re ready. \nDonna: maybe you could even have a taste.. Hehe~" ], 
			[ "Whose berry was bigger?", BAD, "Donna: That would be me... \nBella: What? No way! Mine was bigger! \nDonna: Well mine got picked first! \nBella: that doesn’t matter! Wait a second... farmer... are you trying to sow the seed of doubt between us? \nDonna: oh, are you now? Good luck with that, you can’t separate sister." ], 
			[ "I’m more of a leaf guy myself", NEUT, "Donna: Oh, we don’t exactly have many leaves... \nBella: we have our petals, if that’s more your style?" ]
		],
		[ 5, 1, "Bella: Oh, our dearest farmer... there you are again! \nDonna: I think Bella wants to say she’s glad to see you. And so am I! \nBella: Would you tell us a story? Oh, I hope it's be a good one!", 
			[ "How about a story of two lone mushrooms feeding on a rotten tree trunk?", NEUT, "Donna: hehe, that kind of reminds me of us, Bella! \nBella: It sounds very familiar, but I’ve never heard it \nDonna: me neither, tell us all about if, farmer!" ], 
			[ "How about one about a cute kittens in sweaters?", BAD, "Donna: oh no no no... we don’t do these kinds of stories... \nBella: cuteness is overrated, farmer. And way too simple. Where’s the metaphors? The deeper thought?" ], 
			[ "I know one about an old oak tree filled with regret.", GOOD, "Donna: I think I’ve heard of this one! The oak had a beloved birch tree. One of the was struck by lightning, the other one by grief... It’s a deep story. \nBella: Ah, I see, it’s this one... I bet you’re quite familiar with it, aren’t you?" ]
		],
		[ 6, 1, "Donna: hello there farmer! Bella: we have been thinking of writing another story. \nDonna: but we need some inspiration... We were thinking of writing a romance novel \nBella: but we’ve never been in any kind of romance before... Maybe we could change that..? ", 
			[ "I’ve always wanted to take it further with you two – let's write our story together!", GOOD, "Donna: oh my! Yes! Yes! We would be so happy to work with you!  \nBella: I cannot believe this is actually happening! We promise, we will be yours forever, farmer!" ], 
			[ "why not stick to your ‘dark mysterious’ thing?", NEUT, "Bella: well... it gets kind of boring after a time, doesn’t it? \nDonna: I think so too... \nBella: well, if that’s what you think, farmer, then we suppose we should." ], 
			[ "I’m more of a comedy kinda guy.", BAD, "Bella: Huh? After all this time...? \nDonna: how could you say something like that? I thought you understood us..." ]
		],		
		[ 4, 0, "Donna: Ooooh farmer~  have you seen the flock of ravens in the sky? \nBella: I’ve seen them all bickering, fighting, competing for all the seeds they found... \nDonna: It was quite violent, I’ve heard a bunch of ravens were falling out of the sky! \nBella: I even heard of one which fell right into our garden! Have you heard of this Raven, farmer? ", 
			[ "There’s no raven in here...", NEUT, "Bella: Oh, farmer, you’re not very good with metaphors, are you?" ], 
			[ "I think I know what you’re talking about", GOOD, "Donna: would you look at that, maybe he’s got something in that near-empty skull after all..." ], 
			[ "Stop that, you have idea what really happened!", BAD, "Bella: someone afraid of the truth, wouldn’t you say? Donna: I think so too... well, at some point, you can’t run away from it anymore..." ]
		],
		[ 5, 0, "Bella: time for another story! Donna: I have one, it’s about a family of canaries, broken apart by a big Eagle!  Bella: The mommy canary was left alone to take care of her fledgling. But little does she know, the Eagle is still around, and she is dependent on him to survive... Donna: I wonder, what would she do if she knew the truth? ", 
			[ "Your stories are very creepy... ", NEUT, "Bella: that’s the charm of them, farmer. \nDonna: some stories need to be heard, whether you like them or not." ], 
			[ "I didn’t kill the canary!  You’re both out of your mind!", BAD, "Bella: but who ever said that you were the Eagle, farmer? \nDonna: I think there’s more to the Eagle than meets the eye..." ], 
			[ "Is there any redemption for the Eagle?", GOOD, "Bella: Maybe. Maybe not. I think the canary could never forgive him, but there’s always other ways to change for the better... " ]
		],
		[ 6, 0, "Bella: time for another story! Donna: I have one, it’s about a family of canaries, broken apart by a big Eagle!  Bella: The mommy canary was left alone to take care of her fledgling. But little does she know, the Eagle is still around, and she is dependent on him to survive... Donna: I wonder, what would she do if she knew the truth? ", 
			[ "Your stories are very creepy... ", NEUT, "Bella: that’s the charm of them, farmer. \nDonna: some stories need to be heard, whether you like them or not." ], 
			[ "I didn’t kill the canary!  You’re both out of your mind!", BAD, "Bella: but who ever said that you were the Eagle, farmer? \nDonna: I think there’s more to the Eagle than meets the eye..." ], 
			[ "Is there any redemption for the Eagle?", GOOD, "Bella: Maybe. Maybe not. I think the canary could never forgive him, but there’s always other ways to change for the better... " ]
		],
		[ 7, 0, "Donna: Story time! Story time! \nBella: This one’s from our special collection. A parakeet kept in a cage, to contain its beauty. \nDonna: nobody cared that it was lonely, because its sorrow brought the most beautiful songs. \nBella: Those songs soothed the mind of someone in their final moments. That’s kind of beautiful, don’t you think? ", 
			[ "How do you know this? Where did you get this from!? ", BAD, "Donna: A little birdie told us! \nBella: we’re very good listeners, farmer... Now tell us, did she really deserve to die in that room?" ], 
			[ "It wasn’t fair to the parakeet, and I see that now... ", GOOD, "Bella: That is the truth. But you can’t turn back time \nDonna: At least the parakeet is in a better place now... too bad she didn't make it... both of them wilted that day..." ], 
			[ "Ì don’t really understand these stories of yours...", NEUT, "Donna: There’s no need to play dumb, farmer. \nBella: maybe he’s not pretending. Our metaphors are very sophisticated, after all..." ]
		],
		[ 8, 0, "time for a very special story, farmer... \nBella: there once was a fair queen, who had herself a handsome king. \nDonna: One night, her subject have their gifts to the beloved queen. \nBella: But it didn't go well, for one of them was an assassin. The assassin mistakenly gave the queen a fruit meant for one of her targets. \nDonna: the queen bit into it, and immediately fell very ill!   \nBella: the kingdom grieved her loss, but most of all, the king was stricken by despair... \nDonna: How will you continue the story, my liege? ", 
			[ "Stop that! No more stories! How dare you two kill the queen! ", BAD, "Bella: you should watch your tongue, my liege... \nDonna: or else you’ll join your queen! Bella: and we wouldn’t want that, now would we?" ], 
			[ "Why did the queen die!? ... why did the assassin not tell her about the apple? ", NEUT, "Bella: Remember the story! The assassin didn’t mean to kill the queen. There was no one who paid for her death. \nDonna: it was an accident... we didn’t... I mean, the assassin didn’t... \nBella: that’s enough, Donna." ], 
			[ "The king has to lead its people, no matter what...  I must try my best...", GOOD, "Bella: that’s a good way to look at it. Your subject still depend on you, after all... \nDonna: just try not to kill everyone, alright?" ]
		],
		#[ 0.9, 1, "Bella: oh, farmer, something terrible is happening! \nDonna: we’re dying! Please, we’re withering! Wilting! Drying up and crumbling away! \nBella: please, farmer, we need some sustenance...  ", 
		#	],
		#[ 0.9, 0, "Bella: you don’t like our stories much, do you?  \nDonna: do you want us to take our secrets to our grave? That's quite harsh, isn’t it? \nBella: It’s your decision, farmer, But remember: killing us won’t erase your sins.  ", 
		#	],	
	],
	"Poppy": [
		[ 1, 0.5, "Poppy: Hello there! \nBobby: hello, Mister!  \nPoppy: you seems like you’re this garden’s gardener. Why don’t you tell us more about yourself? Let’s see... oh!  I know! What do you enjoy the most while gardening?", 
		...
		[ 2, 0.5, "I wish I could be young again, sometimes. Carefree, not having any responsibilities, just like a little kid again. ", 
		...
		[ 4, 1, " Bobby: I wanna play! Mr. Gardener, would you like to play with me? I’ll teach you a game my daddy taught me!", 
		...
		[ 5, 1, " Oh hello there farmer! I’ve been waiting for you. I've been really tired lately, Bobby couldn’t sleep well last night... I've just had a lot on my plate recently.", 
		...
		[ 6, 1, " You know, farmer, I’ve been a bit lonely lately. I’m on my own with Bobby, But it doesn’t have to stay that way, if you know what I’m saying... ", 
		...
		[ 6, 0, "Poppy: Hello, gardener, Bobby just fell asleep...I know yout two don't get along too well, so... maybe we could finally have a talk. I don't really like you, gardener, because... you keep bringing up past wounds. ", 
	...
	"Sunflower": [
		[ 1, 0.5, "Hiya there! Nice to meet you! My name is Sunflower, but you can call me Sunny. How are you doing on this sunny day? Hehe~  ", 
		...
		[ 2, 0.5, "It’s great to see all these different flowers around. I’ve never seen some of them before! Like, have you seen Bella and Donna? They seem so dark, and mysterious... I think they’re like poets, or something? Anyways, I’d like to hear some of their stories sometime.", 
		...
		[ 3, 0.5, "Hiya, gardener! I’m kind of curious about you. I feel like we should get to know each other more. How about you tell me where you’re from and I’ll tell you something about myself! ", 
		...
		[ 4, 1, "Hiya there, farmer! I’ve been feeling really grateful for being in this garden, ya know? It’s not too crowded here, plenty of sun and water... I guess what I’m trying to say is, Thank you for planting me here! Ehe~ ", 
		...
		[ 5, 1, "Hiya there, gardener! How's your garden doing today? I hope there aren’t any pests that are giving you trouble. Would you like to cloud gaze with me? There's I can see a few over there... do any of them remind you of something?", 
		...
		[ 6, 1, "Hiya there, gardener! I- I actually wanted to tell you something today... You see.. I think I have a little crush on you! Now, I understand if you don’t share these feelings, but I don’t think I can keep them all in anymore! So... I guess what I’m asking is... do... you like me too?", 
		...
		[ 4, 0, " Oh, hiya gardener!...um... sorry, I’m not really feeling too great right now... I’m kind of stuck in thought, you know how it is... sorry I’m not as cheerful as always...", 
		...
		[ 5, 0, " Oh, it’s you, gardener... Isn’t it a lovely day today? Gosh, I’m so sorry, I really can’t do this right now... I can’t make myself be happy, no matter how hard I try... will you please forgive me?", 
